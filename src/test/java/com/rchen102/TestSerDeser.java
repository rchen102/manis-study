...
public class TestSerDeser {
    ...
    public void testSerDeser() throws Exception {
        /* 加载 Invocation 类 */
        Class clazz = Class.forName("com.rchen102.ipc.SerializableRpcEngine$Invocation");
    ...
    public void testRpcRequestWrapper() throws Exception {
        ProtobufRpcEngineProtos.RequestHeaderProto header = ProtobufRpcEngineProtos.RequestHeaderProto.newBuilder()
                ...
                .build();
        ClientManisDbProtocolProtos.GetTableCountRequestProto req = ClientManisDbProtocolProtos.GetTableCountRequestProto.newBuilder()
                .setDbName("db1")
                .setTbName("tb1")
                .build();

        Class clazz = Class.forName("com.rchen102.ipc.ProtobufRpcEngine$RpcRequestWrapper");
        ...
        ClientManisDbProtocolProtos.GetTableCountRequestProto deSerReq = ClientManisDbProtocolProtos.GetTableCountRequestProto.parseFrom(theRequestRead);
